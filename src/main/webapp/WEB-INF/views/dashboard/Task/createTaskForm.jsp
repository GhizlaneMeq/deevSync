...
<div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-700 border-dashed rounded-lg">
        ...
        <section class="mx-auto w-6/12">
            <div class="rounded-lg bg-gray-800 p-8 shadow-lg lg:col-span-3 my-4">
                <form class="space-y-4" action="tasks?action=create" method="post">
                    <div>
                        <label class="" for="title">Title</label>
                        <input
                                class="w-full rounded-lg border border-gray-600 bg-gray-700 text-gray-200 p-3 text-sm"
                                placeholder="Title"
                                type="text"
                                name="title"
                                id="title"
                    ...
                    <div>
                        ...
                        <select id="tag" class="js-example-basic-multiple w-full rounded-lg border border-gray-600 bg-gray-700 text-gray-200 p-3 text-sm" name="tags[]" multiple="multiple">
                    ...
                    <div class="mt-4">
                        <button
                                type="submit"
                                class="inline-block w-full rounded-lg bg-blue-600 px-5 py-3 font-medium text-white hover:bg-blue-500 sm:w-auto"
                        >
                            Create Task
                        </button>
                    </div>
