...
<section class="bg-gray-900 flex-grow"> <!-- Added flex-grow to make section take full width -->
    <div class="container px-6 py-10 mx-auto"> <!-- mx-auto centers the container -->
        ...
        <div class="grid grid-cols-1 gap-2.5 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-3 xl:grid-cols-5"> <!-- Ensure grid takes full width -->
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Create New Tag</h3>
